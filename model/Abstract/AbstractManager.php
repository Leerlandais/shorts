...
abstract class AbstractManager
{
    ...
    protected function updateAnything(array $data, string $uniqueField, int $uniqueId, string $dbName, string $dbType = "db"): bool
    {
        ...
        $stmt->execute(array_merge($data, ["id" => $uniqueId]));
